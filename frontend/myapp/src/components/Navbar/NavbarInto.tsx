                ...
                <div className='nav-links'>
                    <div className='flex flex-row items-center relative flex-nowrap gap-x-3'>
                        ...
                        <div className="relative">
                            ...
                            <div className='absolute account-menu space-y-2 divide-y divide-neutral-200 px-1 py-2 top-full  shadow-2xl shadow-neutral-900 rounded-xl bg-white  w-[220px]'>
                                <ul className='text-sm font-medium'>
                                    <li className='hover:bg-neutral-200 px-3 flex items-center gap-x-2 cursor-pointer rounded-lg py-2.5'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                    ...
                                    <li className='hover:bg-neutral-200 px-3 flex items-center gap-x-2 cursor-pointer rounded-lg py-2.5'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                        ...
                                        Your Wallet</li>
                                    <li className='hover:bg-neutral-200 flex items-center gap-x-2 px-3 cursor-pointer rounded-lg py-2.5'>
