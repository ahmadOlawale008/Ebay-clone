...
const Button: React.FC<ButtonProps> = ({ children, fullWidth, baseClassName, ringEffect = true, rounded = "md", className, icon, iconPosition = "start", color = "secondary", variant = "text", size = "medium", ...props }) => {
    const btnBaseClassNames = `active:scale-[0.98] gap-x-2 disabled:scale-0 disabled:hover:bg-transparent disabled:active:bg-transparent ease-in-out font-semibold tracking-wider inline-flex text-center justify-center items-center m-0
