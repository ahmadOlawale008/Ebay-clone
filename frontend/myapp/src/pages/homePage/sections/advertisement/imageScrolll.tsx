        ...
        <div className='overflow-hidden  py-5'>
            <div className="-rotate-1 mt-4">
                <div className="flex my-2 items-center justify-center">
                    <span className='p-3 text-3xl italic font-thin tracking-widest text-secondary-light -rotate-1 font-cursive'>Sales Categories</span>
                </div>
                                ...
                                >
                                    {ScrollContent.map((d) => (
                                        <motion.a href={d.link} key={d.id} className='flex flex-1 basis-full items-center'>
                                            <Button
                                                baseClassName='px-3 inline-flex w-full items-center justify-center text-center py-4 active:scale-1 active:shadow-none font-normal text-md tracking-tight leading-loose'
                                                rounded='none'
                                                color='primary'
