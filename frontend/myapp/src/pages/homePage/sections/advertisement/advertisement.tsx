      ...
      <div className="min-h-screen items-start flex flex-col relative bg-gray-100">
        <div className=" container mx-auto px-12 py-6 h-auto overflow-hidden self-start gap-x-3 grid grid-cols-5  flex-auto w-full items-center ">
          <div className="flex flex-col gap-y-5 -mt-8 col-span-2 ">
            ...
            <Button variant="filled" iconClassName="bg-red-500" baseClassName="text-white mt-3 rounded-none shadow-btn" icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4">
          ...
          <div className="col-span-3 gap-x-6 p-3   grid grid-cols-2">
            <div className="flex flex-col gap-y-5">
              <div className="rounded-lg min-h-[200px] relative overflow-hidden flex basis-1/3">
                <LazyLoadImage effect="blur" width={"100%"} height={"100%"} threshold={0.4} src={image} loading="lazy" className="size-full bg-gray-200 absolute top-0 left-0 object-cover" alt="image-card" />
              </div>
              <div className="rounded-lg min-h-[200px] relative overflow-hidden flex basis-1/3">
                <LazyLoadImage effect="blur" width={"100%"} height={"100%"} threshold={0.4} src={imageF} loading="lazy" className="size-full bg-gray-200 absolute top-0 left-0 object-cover" alt="image-card" />
              </div>
              <div className="rounded-lg min-h-[200px] relative overflow-hidden flex basis-1/3">
                <LazyLoadImage effect="blur" width={"100%"} height={"100%"} threshold={0.4} src={imageG} loading="lazy" className="size-full bg-gray-200 absolute top-0 left-0 object-cover" alt="image-card" />
              </div>
            </div>
            <div className=" flex flex-col gap-y-5">
              <div className="rounded-lg  relative overflow-hidden flex basis-1/5">
                <LazyLoadImage  effect="blur" width={"100%"} height={"100%"} src={imageD} threshold={0.4} loading="lazy" className="size-full bg-gray-200 aspect-auto absolute top-0 left-0 object-cover" alt="image-card" />
              </div>
              <div className="rounded-lg min-h-[200px] relative overflow-hidden flex basis-1/2">
                <LazyLoadImage  effect="blur" width={"100%"} height={"100%"} threshold={0.4} src={imageB} loading="lazy" className="size-full bg-gray-200 absolute top-0 left-0 object-cover" alt="image-card" />
              </div>
