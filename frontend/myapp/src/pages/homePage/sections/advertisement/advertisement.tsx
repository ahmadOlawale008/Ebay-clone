        ...
        <div className="max-md:px-1 max-md:py-2 px-12 py-6 h-auto overflow-hidden max-md:mt-12 max-md:flex max-md:flex-col self-start gap-x-3  grid grid-cols-5  flex-auto w-full items-baseline ">
          ...
          <div className="col-span-3 gap-x-6 p-3   grid grid-cols-2">
            <div className="flex flex-col gap-y-5">
              ...
              <div className="rounded-lg min-h-[200px] relative overflow-hidden flex basis-1/3">
                <LazyLoadImage effect="blur" width={"100%"} height={"100%"} threshold={0.4} src={imageC} loading="lazy" className="size-full bg-gray-200 absolute top-0 left-0 object-cover" alt="image-card" />
              </div>
            </div>
            <div className=" flex flex-col gap-y-5">
              ...
              <div className="rounded-lg min-h-[200px] relative overflow-hidden flex basis-1/2">
                <LazyLoadImage effect="blur" width={"100%"} height={"100%"} threshold={0.4} src={imageE} loading="lazy" className="size-full bg-gray-200 absolute top-0 left-0 object-cover" alt="image-card" />
              </div>
