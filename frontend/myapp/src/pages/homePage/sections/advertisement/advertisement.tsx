  ...
  return (
    <div>
      <div className="min-h-screen items-start flex flex-col relative bg-gray-100">
        <div className="px-12 py-6 h-auto overflow-hidden self-start gap-x-3 grid grid-cols-5  flex-auto w-full items-center ">
          <div className="flex flex-col gap-y-7 col-span-2 ">
            <h4 className="font-monospace font-normal text-lg">Lorem ipsum dolor sit amet.</h4>
            <h3 className="text-3xl leading-relaxed font-black">Shop Online With Us.</h3>
            <p className="leading-snug">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo minus nobis sunt sapiente accusantium optio deleniti dolore odio, illum quidem excepturi soluta nostrum ipsam tenetur? Suscipit.</p>
            <span className="text-xl font-monospace font-normal">
              <span className="font-medium">₦2900</span>
              <sub className="line-through">₦5700</sub>
            </span>
            <Button variant="filled" baseClassName="text-white rounded-none shadow-btn" icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4">
              <path fill-rule="evenodd" d="M7.5 6v.75H5.513c-.96 0-1.764.724-1.865 1.679l-1.263 12A1.875 1.875 0 0 0 4.25 22.5h15.5a1.875 1.875 0 0 0 1.865-2.071l-1.263-12a1.875 1.875 0 0 0-1.865-1.679H16.5V6a4.5 4.5 0 1 0-9 0ZM12 3a3 3 0 0 0-3 3v.75h6V6a3 3 0 0 0-3-3Zm-3 8.25a3 3 0 1 0 6 0v-.75a.75.75 0 0 1 1.5 0v.75a4.5 4.5 0 1 1-9 0v-.75a.75.75 0 0 1 1.5 0v.75Z" clip-rule="evenodd" />
            </svg>
            }>Shop</Button>
          </div>
          <div className="col-span-3 gap-x-2  h-full grid grid-cols-2">
            <div className=" flex flex-col gap-y-3">
              <div className="rounded-lg min-h-[200px] relative overflow-hidden flex basis-1/4">
                <img src={imageD} className="size-full aspect-auto absolute top-0 left-0 object-cover" alt="" />
              </div>
              <div className="rounded-lg min-h-[200px] relative overflow-hidden flex basis-1/2">
                <img src={imageB} className="size-full absolute top-0 left-0 object-cover" alt="" />
              </div>
              <div className="rounded-lg min-h-[200px] relative overflow-hidden flex basis-1/4">
                <img src={image} className="size-full absolute top-0 left-0 object-cover" alt="" />
              </div>
            </div>
            <div className="flex flex-col gap-y-3">
