        ...
        <div className="top-categories">
            <div className="mt-4 mb-3 px-0 ">
                <div className="recently-headoai flex items-center justify-between">
                    <div className="content-name"><h1 className='text-2xl my-7 font-semibold'>Categorized by Fashion</h1></div>
                    <div className="content-link"><a className='underline text-xl underline-offset-2 hover:text-neutral-600' href="" target='_'>See all</a></div>
                </div>
                <div className="relative w-full">
                    ...
                    <span onClick={(e) => handleScrollCardPosition(e, categoriesWrapperRef, availableCardController)} data-direction="left" className={`absolute top-1/3 ${availableCardController == "right" && "opacity-20 backdrop-blur-md"} sm:left-0 -left-5 shadow-lg shadow-neutral-500 cursor-pointer  bg-white rounded-full inline-flex items-center justify-center p-2 hover:bg-gray-300 active:scale-[0.99]`}>
                    ...
                    <span onClick={(e) => handleScrollCardPosition(e, categoriesWrapperRef, availableCardController)} data-direction="right" className={`absolute top-1/3 right-0 ${availableCardController == "left" && "opacity-20 backdrop-blur-md"} sm:right-0 -right-5  shadow-lg shadow-neutral-500 cursor-pointer  bg-white rounded-full inline-flex items-center justify-center p-2 hover:bg-gray-300 active:scale-[0.99] `}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-[1em] font-black text-3xl">
            ...
            <div className="mt-4 mb-3 px-0 ">
                <div className="recently-headoai flex items-center justify-between">
                    <div className="content-name"><h1 className='text-2xl my-7 font-semibold'>Electronics, Cars and Computer Gadgets</h1></div>
                    <div className="content-link"><a className='underline text-xl underline-offset-2 hover:text-neutral-600' href="" target='_'>See all</a></div>
                </div>
                <div className="relative w-full">
                    ...
                    <span onClick={(e) => handleScrollCardPosition(e, categoriesWrapperRefB, availableCardControllerB)} data-direction="left" className={`absolute top-1/3 ${availableCardControllerB == "right" && "opacity-20 backdrop-blur-md"} sm:left-0 -left-5 shadow-lg shadow-neutral-500 cursor-pointer  bg-white rounded-full inline-flex items-center justify-center p-2 hover:bg-gray-300 active:scale-[0.99]`}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-[1em] font-black text-2xl">
                            <path fillRule="evenodd" d="M7.72 12.53a.75.75 0 0 1 0-1.06l7.5-7.5a.75.75 0 1 1 1.06 1.06L9.31 12l6.97 6.97a.75.75 0 1 1-1.06 1.06l-7.5-7.5Z" clipRule="evenodd" />
                        </svg>
                    </span>
                    <span onClick={(e) => handleScrollCardPosition(e, categoriesWrapperRefB, availableCardControllerB)} data-direction="right" className={`absolute top-1/3 right-0 ${availableCardControllerB == "left" && "opacity-20 backdrop-blur-md"} sm:right-0 -right-5  shadow-lg shadow-neutral-500 cursor-pointer  bg-white rounded-full inline-flex items-center justify-center p-2 hover:bg-gray-300 active:scale-[0.99] `}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-[1em] font-black text-2xl">
                            <path fillRule="evenodd" d="M16.28 11.47a.75.75 0 0 1 0 1.06l-7.5 7.5a.75.75 0 0 1-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 0 1 1.06-1.06l7.5 7.5Z" clipRule="evenodd" />
                        </svg>
                    </span>
